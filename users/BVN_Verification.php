...
<h3 class="mb-sm-0">BVN Verification</h3>
...
<li class="breadcrumb-item active" aria-current="page">BVN Verification</li>
</ol>
</nav>
</div>
</div>
...
<br>
<b style="display:none;" id="loaders"><img src="../loader/loader.gif" style="height:16px"> Verifying BVN ! Please wait...</b>
...
<h5 class="modal-title" id="exampleModalLabel">BVN DATA</h5>
</div>
