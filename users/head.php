...
Pin, Mapped, Address, Gender, Phone, Sale_Target FROM users WHERE Username = ?");
...
<span class="item-name" Style="font-size:11px">DASHBOARD</span>
</a>
</li>
...
?>
<li class="nav-item" style="font-size: 10px">
<a class="nav-link" data-bs-toggle="collapse" href="#<?php echo $ta; ?>" role="button" aria-expanded="false" aria-controls="sidebar-special" id="hr">
<i class="icon" data-bs-toggle="tooltip" title="<?php echo $ta; ?>" data-bs-placement="right" style="text-transform:uppercase" id="tit">
<i class="fa fa-square" style="font-size:14px;"></i>
</i>
<span class="item-name" style="margin-left:14px; text-transform:uppercase" > <?php echo $ta; ?></span>
<i class="right-icon">
...
<?php
$Query = "SELECT role, Name FROM  control WHERE Tab = '$ta' AND Groups = '$gr' AND Role_Categorys = '$ct' ORDER BY Name ASC";
...
$name = $mrows['Name'];
?>
<ul class="sub-nav collapse" id="<?php echo $ta; ?>" data-bs-parent="#sidebar-menu">
<li class="nav-item">
<a class="nav-link " href="<?php echo $mroles; ?>.php">
<i class="icon">
...
<i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Create Branch" data-bs-placement="right"></i>
...
<i class="icon" data-bs-toggle="tooltip" title="<?php echo $ta; ?>" data-bs-placement="right">
<i class="fa fa-square" style="font-size:14px;"></i>
</i>
<span class="item-name" style="margin-left:14px;">PROFILE</span>
<i class="right-icon">
<svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
</svg>
...
<i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="User Profile" data-bs-placement="right"></i>
...
<!--logo End-->         
<h4 class="logo-title d-block d-xl-none">FINANZA</h4>
</a>
<div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
<i class="icon d-flex">
