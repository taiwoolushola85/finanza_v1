...
$(document).ready(function() {
    ...
    // This is the specific fix for the "Double Click" / "Multiple Request" bug.
    $(document).off('click', '.invks').on('click', '.invks', function(e) {
        ...
        $profileContainer.html(`
            <div class="d-flex flex-column align-items-center justify-content-center p-5" style="min-height: 250px;">
                ...
                <p class="text-muted">Loading flexi saving transactions...</p>
            </div>`);
            ...
            error: function() {
                $profileContainer.html(`
                    <div class="alert alert-danger m-3 text-center">
                        <b>Error:</b> Could not load transactions. Please check connection.
                    </div>`);
            }
        });
    });
