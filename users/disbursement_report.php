...
<div class="col-sm-3">
<label style="font-size:13px">Loan Officer</label><i id="loading" style="display:none; float:right"><img src="../loader/loader.gif" style="height:14px"> Loading.....</i>
...
<select class="form-control form-control-md" name="pr">
<option value="">All</option>
<?php 
include_once '../config/db.php';
$Query = "SELECT  * FROM product WHERE Status = 'Activated' ORDER BY id DESC";
$result = mysqli_query($con, $Query);
$Count = mysqli_num_rows($result);
if ($Count > 0) {
for ($j=0 ; $j < $Count; $j++){
