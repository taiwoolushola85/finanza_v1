...
$whereConditions = ["Status = 'Paid'", "Date_Paid BETWEEN '$st' AND '$en'", "Post_Method != 'Recovery Posting'"];
...
<div class="row">
    <div class="col-sm-3">
        <b style="font-size:11px">Total Repayment: <?php echo number_format($summary['total_repayment'], 2); ?></b>
    </div>
     <div class="col-sm-3">
...
if (!empty($br) && !empty($ln)) {
    $filename = 'Loan_Officer_history.json';
} elseif (!empty($br)) {
    $filename = 'branch_history.json';
}
    ...
    <table id="repaymentTable">
        ...
        <tbody>
            ...
            <tr style="font-size:9px;">
                ...
                <td class="sort border-top"><?php echo htmlspecialchars($member['Post_Method']); ?></td>
...
function downloadCSVFile(csv_data) {
    ...
    temp_link.download = "Repayments_Collection.csv";
