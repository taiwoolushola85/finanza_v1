                            ...
                            <div class="p-3">
                                ...
                                <div class="d-grid gap-3 grid-cols-1 mb-4">
                                    <div class="form-group mb-0">
                                        <input type="text" data-setting="input" maxlength="10" class="form-control" value="FINANZA">
                                    </div>
                                </div>
...
<div class="right-panel" style="font-size:12px">
© <?php echo date('Y'); ?> <span >FINANZA</span>, Designed
<span class="text-gray">
</span> By <a href="#">I-Create Solutions</a>.
</div>
</div>
</footer>
<!-- Footer Section End -->
